...
SpriteXY.prototype.init = function() {
  ...
  this.$transparentBGSelector.click(function() {
    ...
    $colorChangeElements.css('background-image', '').addClass('transparent-bg');
  ...
  function loadImageFile() {
    if (oSpriteXY.$spriteUploadControl.get(0).files.length === 0) {
      return;
    }
